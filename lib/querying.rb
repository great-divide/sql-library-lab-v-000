...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN characters ON series.id = characters.series_id HAVING characters.species = 'human' GROUP BY series ORDER BY COUNT(characters.species) LIMIT 1"
end
